define(["./argv", "./fileUtils", "./defaultBuildControl", "./gates", "./configStringify"], function(args, fileUtils, defaultBuildControl, gates, stringify) {
  ...
  bc.destBasePath= compactPath(cleanupPath(
    args.destBasePath ||
    (bc.build && bc.build.destBasePath) ||
    bc.destBasePath ||
    (bc.basePath + (bc.basePathSuffix || "-build"))));
