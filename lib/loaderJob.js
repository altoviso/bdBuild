...
//
define(["./fileUtils", "./buildControl", "./configStringify", "./packageJob", "bdParse", "text!bdBuild/has/bdLoadHas.js"], function(fileUtils, bc, configStringify, packageJob, bdParse, defaultHasImpl) {
var
  read= function(
    cb
  ) {  
