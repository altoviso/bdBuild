...
var
  ...
  amdLoaderConfig= {
    baseUrl: __dirname.match(/^(.+)bdBuild\/lib$/)[1],
    packages:[{
      name:"bdBuild"
    }, {
      name:"bdParse"
...
// load and configure the AMD loader; define the args modules
require(args.amdLoader || "../../bdLoad/lib/node");
define("*config", args.amdLoaderConfig || amdLoaderConfig);
define("args", 0, args);

// these node modules are used by AMD modules; provide access
...
define("*load", ["bdBuild/fileUtils", "bdBuild/buildControl"], function(fileUtils, buildControl) {
  var 
