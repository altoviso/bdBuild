...
//
define(["bdBuild/fileUtils", "bdBuild/buildControl", "bdParse"], function(fileUtils, bc, bdParse) {
var
  ...
  read= function(
    ...
    var 
      src= catPath(this.srcLocation, this.srcLib),
      dest;
    if (this.destLocation.indexOf(bc.destRootPath)) {
      ...
      dest= catPath(this.destLocation, this.destLib);
    }
