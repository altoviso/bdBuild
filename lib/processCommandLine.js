...
if (!build.length) {
  console.log("no build information given; trying to read config.js in the current working directory");
  build.push(loadBuildInfo(normalizeArgPath("config.js"), "requireConfig"));
