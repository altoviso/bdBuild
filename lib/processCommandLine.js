...
var
  ...
  normalizePath= function(path, base) {
    // return path relative to base iff path is relative; otherwise return path
  ...
  normalizeArgPath= function(path) {
    // normalize path with respect to the current working directory when build is executed
    return normalizePath(path, cwd);
  },

  normalizePropPath= function(o, p, base) {
    // normalize property p in object o, a path, with repsect to base iff o[p] is relative
    if (o[p]) {
  ...
  loadBuildInfo= function(
    ...
    // This function load, evaluate and return the result of the contents of the file given by
    ...
    try {
      ...
      if (scopeType=="config") {
        src= "(function(){var result; function define(a1, a2){ result= a2; };" + src + "; return result;})();";
